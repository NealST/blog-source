...
>
> 范例文件：[`xiaohongshu-examples/文字卡片-范例.html`](./xiaohongshu-examples/文字卡片-范例.html)
...
- 卡片内 padding：`40px 44px 28px`
- 段落字号：`18px / line-height 1.85`（与公众号正文一致）
...
```css
.post-body p { font-size: 18px; line-height: 1.85; color: #333; margin-bottom: 20px; }
